import 'package:flutter/material.dart'; //pacote flutter
...
class MeuAplicativo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: ThemeData(primarySwatch: Colors.red), // tema do app
      home: Scaffold(
        appBar: AppBar(
        ...
        body: Column( //Column formatação em colunas
          children: [
            const Image(
            ...
            Container(
              margin: const EdgeInsets.fromLTRB(12.0, 0.0, 20.0, 0), ////Posicionamneto 
              child:  Row( // Formatação em linhas
                children: [
                  const Expanded(
                    child: Column(
                        ...
                        TextButton(
                          ...
                          child: const Column(
                           children: [
                            ...
                            Icon(Icons.calendar_month, color: Colors.blue), //Ícones
                           ],
                          ),
                        ),
                      ],
            ...
            Container(
                margin: const EdgeInsets.fromLTRB(25.0, 5.0, 30.0, 30), //Posicionamneto do objeto
                child:  const Row(
                  children: [
                    Expanded(
                      child: Text(
                        ...
                        style: TextStyle(height: 1.5, fontSize: 16), textAlign: TextAlign.justify, //Formatação do objeto: height- espaçamento, fontSize- tamanho fonte, textAlign.justify - justificar texto
                      ),
            ...
            Container(
              margin: EdgeInsets.fromLTRB(90.0, 20.0, 10.0, 0),
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.end,
                children: [
                  TextButton(
